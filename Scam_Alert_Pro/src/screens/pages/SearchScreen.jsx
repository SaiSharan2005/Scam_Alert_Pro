...
const SearchScreen = ({ navigation }) => {
  ...
  const customGradient = isDark
    ? ["#000000", "#8E1A7B"]
    : ["#8E1A7B", "#FFFFFF"];
  const Searchlogo = isDark ? Searchdark : Search;
    ...
    <View style={styles.recommendationRow}>
      ...
      {item.id !== currentUserId && (
        <TouchableOpacity
          ...
          style={[
            styles.followBtn,
            { backgroundColor: themeColors.followbutton },
          ]}
        >
          <Text style={[styles.followText, { color: themeColors.buttontext }]}>
  ...
  return (
    <View style={{ flex: 1 }}>
      <LinearGradient colors={customGradient} style={styles.gradient}>
        {/* Search bar */}
        <View
          style={[styles.searchBar, { backgroundColor: themeColors.searchBar }]}
        >
          <TextInput
          ...
          {searchText.trim() === "" && (
            <View
              style={[
                ...
                { backgroundColor: themeColors.searchSection },
              ]}
            >
              ...
              {newUsers.length > 0 ? (
                ...
                <Text
                  style={[styles.fallbackText, { color: themeColors.text }]}
                >
                  No new users found.
                </Text>
              )}
        ...
        <View>
          {searchText.trim() === "" && (
            ...
            >
              <Text
                style={[styles.recommendTitle, { color: themeColors.text }]}
              >
                Recommendations
              </Text>
              {recommendedUsers.length > 0 ? (
                ...
                <ActivityIndicator color="#8E1A7B" size="large" />
              ) : (
                <Text
                  style={[styles.fallbackText, { color: themeColors.text }]}
                >
