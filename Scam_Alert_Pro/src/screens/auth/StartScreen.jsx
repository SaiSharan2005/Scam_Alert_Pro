...
export default function StartScreen({ navigation }) {
  ...
  return (
    <LinearGradient colors={customGradient} style={styles.gradient}>
      <ScrollView contentContainerStyle={[styles.container, {backgroundColor:themeColors.startcontainer} , {borderColor:themeColors.startborder}]}>
        <Image source={LogoPic} resizeMode="contain" style={styles.logo} />

        <Text style={[styles.heading, {color:themeColors.text}]}>Signup or Login</Text>
